...
FUNC 
  : TIPO ID parenA PARAMS parenC llaveA SENTS llaveC  
      {{ $$ = { tipo:'funcion', hijos: [$1, $2, $4, $7], tipoDato:$1.val,  linea: yylineno, columna:  @1.first_column, lineaF:  @8.last_line, columnaF:  @8.last_column } }}        
  | ID  ID parenA PARAMS parenC llaveA SENTS llaveC 
      {{ $$ = { tipo:'funcion', hijos: [$1, $2, $4, $7], tipoDato:$1.val,  linea: yylineno, columna:  @1.first_column, lineaF:  @8.last_line, columnaF:  @8.last_column } }}        
  | vacio ID parenA PARAMS parenC llaveA SENTS llaveC  
      {{ $$ = { tipo:'funcion', hijos: [$1, $2, $4, $7], tipoDato:$1,  linea: yylineno, columna:  @1.first_column, lineaF:  @8.last_line, columnaF:  @8.last_column } }}          
  ...
  | TIPO ID parenA parenC llaveA SENTS llaveC  
      {{ $$ = { tipo:'funcion', hijos: [$1, $2, $6], tipoDato:$1.val,  linea: yylineno, columna:  @1.first_column, lineaF:  @7.last_line, columnaF:  @7.last_column } }}        
  | ID ID parenA parenC llaveA SENTS llaveC 
      {{ $$ = { tipo:'funcion', hijos: [$1, $2, $6], tipoDato:$1.val,  linea: yylineno, columna:  @1.first_column, lineaF:  @7.last_line, columnaF:  @7.last_column } }}        
  | vacio ID parenA parenC llaveA SENTS llaveC  
      {{ $$ = { tipo:'funcion', hijos: [$1, $2, $6], tipoDato:$1,  linea: yylineno, columna:  @1.first_column, lineaF:  @7.last_line, columnaF:  @7.last_column } }}          
...
LLAMADA
  : ID parenA EXPS parenC
      {{ $$ = { tipo:'llamada', hijos: [$1, $3],  linea: yylineno, columna:  @1.first_column, lineaF:  @4.last_line, columnaF:  @4.last_column } }}        
  | ID parenA parenC 
...
DECLARA 
    : TIPO ID            {{ $$ = { tipo:'decl', hijos:[$1, $2], tipoDato:$1.val,     linea:  yylineno, columna:  @1.first_column, lineaF:  @2.last_line, columnaF:  @2.last_column } }}        
    | ID ID            {{ $$ = { tipo:'decl', hijos:[$1, $2], tipoDato:$1.val,     linea:  yylineno, columna:  @1.first_column, lineaF:  @2.last_line, columnaF:  @2.last_column } }}        
    | ID ID asigna E           {{ $$ = { tipo:'decl', hijos:[$1, $2, $4], tipoDato:$1.val,     linea:  yylineno, columna:  @1.first_column, lineaF:  @2.last_line, columnaF:  @2.last_column } }}        
    | TIPO ID asigna E           {{ $$ = { tipo:'decl', hijos:[$1, $2, $4], tipoDato:$1.val,     linea:  yylineno, columna:  @1.first_column, lineaF:  @2.last_line, columnaF:  @2.last_column } }}        
;
